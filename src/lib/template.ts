...
const PHASE_SLOTS: Record<string, Slot[]> = {
  'General Prep': [
    ...
    { type: 'oncourt', focus: 'Length & accuracy hitting', rpe: 6, detail: { drills: ['straight rails', 'boast-drive', 'figure-8'] } },
  ],
  'Specific Prep': [
    ...
    { type: 'oncourt', focus: 'Condition games — length', rpe: 7, detail: { drills: ['2-corner boast-drive', 'length game'] } },
  ],
